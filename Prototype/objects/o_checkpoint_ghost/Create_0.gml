...
// set the start size
part_type_size(first_particle, .5, .3, 0, .2);
...
// create an emitter
first_emitter = part_emitter_create(global.ps_ghost);
// set the emitter region
part_emitter_region(global.ps_ghost, first_emitter,
	x + base_x - t, x + base_x + t,
	y + base_y - t, y + base_y + t,
	ps_shape_diamond, ps_distr_invgaussian);

// make a burst from the emitter
part_emitter_stream(global.ps_ghost, first_emitter, first_particle, -5);