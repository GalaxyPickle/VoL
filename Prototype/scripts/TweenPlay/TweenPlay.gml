...
//    if (argument_count == 1)
//    {
//        return TGMS_TweenPlay(_t[TWEEN.ID]);
//    }
...
//	            _data[1] = argument[7]; // start
//	            _data[2] = argument[8]; // destination
//	            return TGMS_TweenPlay(_t[TWEEN.ID], _propRaw[0], argument[1], argument[2], argument[3], argument[4], argument[5], 0, 1, _data);
//	        }
//	        else
//	        {
//	            return TGMS_TweenPlay(_t[TWEEN.ID], _propRaw[0], argument[1], argument[2], argument[3], argument[4], argument[5], argument[7], argument[8], _propRaw[1]);
//	        }
//	    }
//	    else // Standard Properties
//	    { 
...
//		            _data[0] = argument[7];
//		            _data[1] = argument[8];
//		            return TGMS_TweenPlay(_t[TWEEN.ID], _propRaw, argument[1], argument[2], argument[3], argument[4], argument[5], 0, 1, _data);
//		        }
//		        else
//				if (ds_map_exists(global.__PropertySetters__, _propRaw)) // optimised property
//		        {
//		            return TGMS_TweenCreate(_t[TWEEN.ID], _propRaw, argument[1], argument[2], argument[3], argument[4], argument[5], argument[7], argument[8]);
//		        }
//			}
//			else // Dynamic Property
//			{
//				return TGMS_TweenCreate(_t[TWEEN.ID], argument[6], argument[1], argument[2], argument[3], argument[4], argument[5], argument[7], argument[8]);
//			}
//	    }
//	}
